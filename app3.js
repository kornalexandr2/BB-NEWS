...
#		output+="<p><center><b>"+ '<iframe width="560" height="315" src="https://www.youtube.com/embed/' . data.items[i].snippet.resourceId.videoId . '" frameborder="0" allowfullscreen></iframe>'+"</b><br><div id='BBVideo'></div>";
